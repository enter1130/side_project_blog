    ...
    return(
        <Row>
            ...
            <Col xs={24} sm={24} md={12} className='p-1'>
                <div className='text-muted over-line' title="content">{item.content}</div>
            ...
            <Col xs={24} sm={24} md={3} className='py-1 d-flex align-items-stretch justify-content-end'>
                <div>
                    <a href="#">檢視</a><span className='px-2'>|</span><a href="#">修改</a>
                </div>
            </Col>
        </Row>
    )
...
function UserBlog() {
    ...
    return (
        <div className='py-3'>
            ...
            <div>
                <List hover bordered style={{maxHeight:'650px'}}>
                {blog.map((item,i)=>(
